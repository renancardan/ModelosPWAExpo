...
export default ({IconSvg, placeholder, value, onChangeText, password, autoCapitalize, keyboardType, setDepTel1, setDepTel2, DepTe1}) => {
    ...
    const AnalizarTel = () =>{
        if(DepTe1 !== value){
            Api.AnaliseTelDep(value, setDepTel2)
        }
