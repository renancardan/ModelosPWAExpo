...
export default ({IdRo, Ocorre, Varia, Nome, Fechar, setModalLoad }) => {
  ...
  const [NomePes, setNomePes] = useState("");
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        ...
        const Enviando = async (Loc, Cid, Est, Nom)=>{
         ...
         setModalLoad(true)
          ...
          await  Api.enviandoPosIni(IdUser, Loc, Nome, Ocorre, Varia);
        } else{
          alert("AVISO",
        ...
        const Enviando4 = async (Loc, Cid, Est, Nom)=>{
