...
export default ({IdRo, setLocV1,  Tipo , LocV1, ChamandoAgora, setModalIr, setLocV2, LocV2 }) => {
  ...
  const IrConfig = ()=>{
    ...
    return ( 
        ...
        <CustomButtonText6>Estado: {Estado2}</CustomButtonText6>      
         ...
         <FlatList 
            ...
            <CustomButton onPress={()=>irEdit2(item)} >
             ...
             <CustomButton2 onPress={()=>IniciandoChamda2()} >
                    <CustomButtonText>Iniciar</CustomButtonText>
            </CustomButton2> 
            ...
            {Tipo === "Apoio" &&
            <>
            <Text style={styles.modalText2}>Posição do atendimento</Text>
            ...
            {Tipo === "Viagem" &&
            <>
             <Text style={styles.modalText2}>Posição Inicial</Text>
         ...
         :
         <CustomButton style={{backgroundColor: "#FFE767"}} >
         <CustomButtonText1>{NomeEd}</CustomButtonText1>
         <CustomButtonText6>Cidade: {Cidade}</CustomButtonText6>
        <CustomButtonText6>Estado: {Estado}</CustomButtonText6>      
        </CustomButton>
         ...
         <FlatList 
            ...
            <> */}
               {Tipo === "Apoio" &&
            <>
             <CustomButton2 onPress={()=>IniciandoChamda()} >
                    <CustomButtonText>Iniciar</CustomButtonText>
            </CustomButton2> 
            ...
            {Tipo === "Viagem" &&
            <>
             <CustomButton2 onPress={()=>IndoParaFinal()} >
