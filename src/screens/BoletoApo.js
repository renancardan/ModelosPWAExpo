...
export default ({route}) => {
  ...
  const [IdApos, setIdApos] = useState(route.params.id)
  ...
  const AnalisandoOlds = ()=>{
    setCarre(true)
    Api.AnaliseOldsBole(SimAp, IdApos, setAnliAp, setAproPag, setStatusAp, setAlert, setAlertTipo, setModalCalend, setVerNotajogo, setCarre)
  }
  ...
  const PegandoGrupCot = ()=>{
    ...
    for(let i in ListOc[0].Best){
      
        if(resli1 .find( BA => BA.label === ListOc[0].Best[i].Grupo)){

        } else {

          resli1.push({
            label:ListOc[0].Best[i].Grupo,
            value:ListOc[0].Best[i].Grupo,
          })
  ...
  const PegandoAposta= ()=>{
    Api.BoleCri(id, setAnal,  setTokenMp, setApor, setLogo, setNomeEmp, setVaToCo, setValPreDemos, setValorReal, setSimAp, setValApos,setNome, setTelCli, setNomeCam, setTelCam, setConcluir, setPago, setValCambis, setQCash, )
  }

  const VendoReultado = (item)=>{
   console.log(item)
  ...
  const Caulc = ()=>{
        ...
        const AposCambis = ()=>{
         ...
         const PagandoPix = ()=>{
          ...
          if(verSim.includes(1)){
            ...
            setAlert("Algum desses jogos já esta preste a começar ou já começou, Não tem Como Pagar Mais Por Aqui!");
            setAlertTipo("danger");
            setModalCalend(true);
            setVerNotajogo(false);
    ...
    return (
      ...
      />
        ...
        <ScrollView style={{width:400, paddingLeft:50}}>
          { SimAp.length !== 0 && Carre === false ?
          <>
           <View  style={styles.CaixadeapostaTitulo}  >
                    <Text style={{fontWeight:"bold", marginLeft:10, fontSize:20  }}>Boleto da Aposta</Text> 
                      </View> 
                      {SimAp.map((item3, index)=>( 
                        <>
                     <TouchableHighlight   style={styles.Caixadeaposta} onPress={()=>VendoReultado(item3.LinkResu)}   >
                    <>
                     <Text style={styles.TexNota1}>{item3.CasaTime.name.substr(0, 15)}. X {item3.ForaTime.name.substr(0, 15)}.</Text> 
                     <Text style={styles.TexNota1}>Palpite: {item3.Casa} | Cota: {item3.Olds}</Text>
                     <Text style={styles.TexNota1}>({item3.Grupo})</Text>
                     <Text style={styles.TexNota1}><DataTime  data={item3.dataJogo*1000} /> </Text>
                     <Text style={{fontSize:15, color:"blue"}}>Resultado do jogo, Clique Aqui! </Text>
                     ...
                     {StatusAp.map((item25, index)=>(
                      ...
                      {/* <TouchableHighlight style={{width:200, height:30, backgroundColor:"#8F00ED", borderRadius:5, margin:20, flex:1, justifyContent:"center", alignItems:"center" }} onPress={()=>PagandoPix()}>
                      <Text  style={{ margin:10, fontWeight:"bold",  fontSize:16, color:"#FFF"  }}>Resultado do Jogo</Text>
                </TouchableHighlight>            */}
                    </>
                              ))}
                    <Text  style={{fontWeight:"bold", marginLeft:10, fontSize:20, color:"#fff"  }}>Qtd. Jogo(s) {QuanJog} </Text>
                    <Text  style={{fontWeight:"bold", marginLeft:10, fontSize:20, color:"#fff"  }}> Total Cota(s): {VaToCo}</Text> 
                    ...
                    <Text  style={{fontWeight:"bold", marginLeft:10, fontSize:15  }}>Valor:{ValApos}</Text>  
                          ...
                          <View style={styles.Valopre}>
                            <View style={styles.Titupre}>
                            <Text  style={{fontWeight:"bold", margin:10, fontSize:22, color:"#FFF"  }}>Prêmio: R$ {ValPreDemos}</Text>
                            </View>
                            {Pago === false && 
                            <>
                             {MPg === true &&
                          ...
                          {TokenMp !== "" && 
                            <>
                             <Text  style={{fontWeight:"bold", marginLeft:10, fontSize:20, color:"#fff"  }}>Caso Queira Pagar Com Pix ou Cartão de Credito, por meio do Mercado Pago Clique Abaixo </Text> 
                          <TouchableHighlight style={{width:150, height:50, backgroundColor:"#1ED31A", borderRadius:5, margin:20, flex:1, justifyContent:"center", alignItems:"center" }} onPress={()=>PagandoPix()}>
                            <Text  style={{ margin:10, fontWeight:"bold",  fontSize:16, color:"#FFF"  }}>Pague Por Aqui</Text>
                          </TouchableHighlight>
                            ...
                            <>
                            {Apor === true?
                            <Image source={require("../assets/trofeu.png")}  style={styles.ImageIcon } />
                            :
                            <Image source={require("../assets/perda-de-apetite.png")}  style={styles.ImageIcon } />
                            }
                            ...
                            :
                            <Image source={require("../assets/pensando.png")}  style={styles.ImageIcon } />
                            }
