...
export default ({route}) => {
  ...
  const [DadoTitu, setDadoTitu] = useState(null)
  const [DadoFili, setDadoFili] = useState(null)
  const [DadosBet, setDadosBet] = useState(null)
  ...
  useEffect(() => {
    console.log(DadoFili)
    console.log(DadoTitu)
    console.log(DadosBet)
  ...
  const LevarTemp = async ()=>{
    const Mer =  Math.random()*(9999 - 1000) + 1000
  ...
  const PegandoAposta= ()=>{
   Api.PegarDadosLink( id, setDadoFili, setDadoTitu, setDadosBet )
  }
      ...
      console.log(int)
        ...
        const AposCambis = ()=>{
         ...
         const PagandoPix = ()=>{
          ...
          if(verSim.includes(1)){
            ...
            if(DadoTitu.Funcionario === true){
              if(ValPremi <= DadoFili.ConfigEmp.PremioMax){
              if(ValorReal <= DadoFili.ConfigEmp.ValMax){
                if(ValorReal >= DadoFili.ConfigEmp.ValMin){
                  if(SimAp.length >= DadoFili.ConfigEmp.PalMin){
                    if(SimAp.length <= DadoFili.ConfigEmp.PalMax){
                    ...
                    setModalCalend(true);
                  setVerNotajogo(false);
                    setAlert(`${DadoFili.ConfigEmp.PalMax} palpites são o minimo para aprovar uma aposta`);
                    setAlertTipo("danger");
                    ...
                    setModalCalend(true);
                  setVerNotajogo(false);
                    setAlert(`${DadoFili.ConfigEmp.PalMin} palpites são o minimo para aprovar uma aposta`);
                    setAlertTipo("danger");
                  ...
                  setModalCalend(true);
                  setVerNotajogo(false);
                  setAlert(`R$ ${DadoFili.ConfigEmp.ValMin} é o menor valor que você pode aposta!`);
                  setAlertTipo("danger");
                ...
                setModalCalend(true);
                setVerNotajogo(false);
                setAlert(`R$ ${DadoFili.ConfigEmp.ValMax} é o Maior valor que você pode aposta!`);
                setAlertTipo("danger");
              ...
              setModalCalend(true);
              setVerNotajogo(false);
              setAlert(`R$ ${DadoFili.ConfigEmp.PremioMax} é o Valor Máximo que pode ser pago Pelo Prêmio!`);
              setAlertTipo("danger");
              ...
              if(ValPremi <= DadoTitu.ConfigEmp.PremioMax){
              if(ValorReal <= DadoTitu.ConfigEmp.ValMax){
                if(ValorReal >= DadoTitu.ConfigEmp.ValMin){
                  if(SimAp.length >= DadoTitu.ConfigEmp.PalMin){
                    if(SimAp.length <= DadoTitu.ConfigEmp.PalMax){
                    ...
                    setModalCalend(true);
                  setVerNotajogo(false);
                    setAlert(`${DadoTitu.ConfigEmp.PalMax} palpites são o máximo para aprovar uma aposta`);
                    setAlertTipo("danger");
                    ...
                    setModalCalend(true);
                  setVerNotajogo(false);
                    setAlert(`${DadoTitu.ConfigEmp.PalMin} palpites são o mínimo para aprovar uma aposta`);
                    setAlertTipo("danger");
                  ...
                  setModalCalend(true);
                  setVerNotajogo(false);
                  setAlert(`R$ ${DadoTitu.ConfigEmp.ValMin} é o menor valor que você pode aposta!`);
                  setAlertTipo("danger");
                ...
                setModalCalend(true);
                setVerNotajogo(false);
                setAlert(`R$ ${DadoTitu.ConfigEmp.ValMax} é o Maior valor que você pode aposta!`);
                setAlertTipo("danger");
              ...
              setModalCalend(true);
              setVerNotajogo(false);
              setAlert(`R$ ${DadoTitu.ConfigEmp.PremioMax} é o Valor Máximo que pode ser pago Pelo Prêmio!`);
              setAlertTipo("danger");
         ...
         const GerarCod =  async ()=> {
          ...
          if(Robo === false){
            setCarre(true)
            Api.GeradorCodLink(TelCli, Robo, setCarre, setCodLast, setCodG, setAlert, setAlertTipo, setVerNotajogo, setModalCalend);
          } else {
            setModalCalend(true);
            setVerNotajogo(false);
    ...
    return (
      <View style={styles.Container}>
          ...
          <>
                    ...
                    <Text style={{fontWeight:"bold", marginLeft:10, fontSize:20  }}>Regras da Aposta</Text> <View  style={styles.fechaModal} ><TouchableHighlight onPress={() =>Siarnota()}><Text>X</Text></TouchableHighlight></View>
                      </View>
                      {DadoFili !== null &&
                       <>      
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>Qualquer Duvida Esse é O WhatsApp da Nossa Empresa é {DadoTitu.Funcionario?DadoFili.Telefone:DadoTitu.Telefone}  </Text>  
                      </>}
                      <Text  style={{fontWeight:"bold", marginLeft:10, fontSize:17, color:"#000"  }}>Como Fazer Uma Aposta </Text>
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>1-Escolha o dia do jogo que você quer apostar, existe 3 dias disponível. Hoje, Amanhã e Depois de Amanhã.</Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>2-Escolha o Campeonato dos jogos que você gostaria de apostar.</Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>3-Escolha o grupo de cotações que você gostaria de apostar, existe vários, como Gols Acima/Abaixo, Placar Exato e outros.</Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>4-Escolha as Cotações que você quer colocar na nota da aposta, para pode construir sua aposta.</Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>5- Cada cotação escolhida, será multiplicada uma com a outra, pois quando você colocar o valor que queres apostar, será multiplicado pelas cotações escolhidas e resultará no valor do prêmio.</Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>6-Concluido a construção da aposta, Digite seu Nome e WhatsApp, depois Clique em Gerar Código de Segurança da Aposta. Você receberá o código no seu WhatsApp. </Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>7-Digite os 4 números que recebeu no seu WhatsApp  no Campo de Código da Aposta, e clique em Pagar aposta. Você será enviado  para o mercado pago para concluir o pagamento.</Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>8-Concluido o Pagamento, você receberá o boleto da aposta no seu WhatsApp para acompanhar a aposta.</Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>9- Agora vamos para Regras do Resultado e Entrega do Prêmio. </Text>  
                    {DadoFili !== null &&
              <>     
                      <Text  style={{fontWeight:"bold", marginLeft:10, fontSize:17, color:"#000"  }}>Regras para Resultado e Entrega do Prêmio </Text>
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>1-Antes de Comprar a Aposta, coloque seu Nome e WhatsApp.</Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>2-Enviaremos o boleto para seu WhatsApp, para você acompanhar a aposta.</Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>3-A empresa {DadoTitu.Funcionario?DadoFili.ConfigEmp.NomeEmp:DadoTitu.ConfigEmp.NomeEmp } entrará em contato com você para lhe informa se você ganhou ou perdeu a aposta.</Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>4-Caso tenha Ganho o prêmio, a empresa {DadoTitu.Funcionario?DadoFili.ConfigEmp.NomeEmp:DadoTitu.ConfigEmp.NomeEmp } entrará em contato com você via WhatsApp para começar o processo de pagamento do seu prêmio com toda responsabilidade necessária. Por isso é necessário o Seu WhatsApp. </Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>5-O WhatsApp da Nossa Empresa é {DadoTitu.Funcionario?DadoFili.Telefone:DadoTitu.Telefone}  </Text>  
                       
                      <Text  style={{fontWeight:"bold", marginLeft:10, fontSize:17, color:"#000"  }}>Regras para escolha de Cotações</Text>
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>1-Cotação repetida o sistema não aceita.</Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>2-Você Só poderá escolher uma cotação por jogo.</Text>
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>3-Você só poderá escolher cotações de jogos que não começaram.</Text>
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>4-Você não poderá escolher as cotações NAN, pois elas não existe.</Text>
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>5-{DadoTitu.Funcionario?DadoFili.ConfigEmp.PalMax:DadoTitu.ConfigEmp.PalMax} palpites são o máximo para aprovar uma aposta.</Text>
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>6-{DadoTitu.Funcionario?DadoFili.ConfigEmp.PalMin:DadoTitu.ConfigEmp.PalMin} palpites são o mínimo para aprovar uma aposta.</Text>
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>7- R$ {DadoTitu.Funcionario?DadoFili.ConfigEmp.ValMin:DadoTitu.ConfigEmp.ValMin} é o menor valor que você pode aposta.</Text> 
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>8-R$ {DadoTitu.Funcionario?DadoFili.ConfigEmp.ValMax:DadoTitu.ConfigEmp.ValMax} é o Maior valor que você pode aposta</Text>
                      <Text  style={{ marginLeft:10, fontSize:17, color:"#000"  }}>9- R$ {DadoTitu.Funcionario?DadoFili.ConfigEmp.PremioMax:DadoTitu. ConfigEmp.PremioMax} é o Valor Máximo que pode ser pago Pelo Prêmio</Text>
                ...
                <Image source={require('../assets/futebol.gif')}  style={styles.ImageVer5 } />     
                   ...
                   />   
                          ...
                          <View style={styles.Valopre}>
                            ...
                            <Text  style={{ margin:10, fontSize:15  }}>Nós temos total Responsabilidade, para o pagamento do seu prêmio. Nosso WhatsApp {DadoTitu.Funcionario?DadoFili.Telefone:DadoTitu.Telefone}. </Text>
                            <Text  style={{ margin:10, fontSize:15  }}>Antes de Concluir a Aposta, Leia as Regras da Aposta, no topo do sistema, para saber como será pago seu prêmio. </Text>
                      ...
                      {Tentativa < 3 &&
                                  <>
                                   <Text  style={{ marginLeft:10, fontSize:15  }}>Seu Código foi enviado para o Whatsapp, caso não receba, seu telefone está errado.</Text> 
                                   <View  style = {styles.InputAra}>
                   <FontAwesome name="expeditedssl" size={40} color="black" />           
                       ...
                       <TouchableHighlight style={{width:150, height:50, backgroundColor:"#9B1AD3", borderRadius:5, margin:20, flex:1, justifyContent:"center", alignItems:"center" }} onPress={()=>PagandoPix()}>
                            <Text  style={{ margin:10, fontWeight:"bold",  fontSize:16, color:"#FFF"  }}>Pagar Aposta</Text>
                          </TouchableHighlight>
          ...
          style={styles.imageBack} >
            <View style={styles.CaixaTitulo} >
              ...
              <Image source={{uri:DadoFili.LogoEmp }}  style={styles.ImageVer2 } />
              </TouchableHighlight>
             ...
             <Text style={styles.TextInfo} >
              ...
              <>
              <TouchableHighlight  style={styles.CaixaDados}>
              <Image source={{uri:DadoTitu.LogoEmp }}  style={styles.ImageVer2 } />
              </TouchableHighlight>
             ...
             <Text style={styles.TextInfo} >
              ...
              <Text style={{margin:10, fontSize:17, color:"green", fontWeight:"bold"}} >Regras da Aposta</Text>
              </TouchableHighlight>
            ...
            {AbMoney === true &&
             ...
             <Text style={{margin:10, fontSize:17, color:"green", fontWeight:"bold"}} >WhatsApp: {DadoTitu.Funcionario?DadoFili.Telefone:DadoTitu.Telefone}  </Text>
             </View>
